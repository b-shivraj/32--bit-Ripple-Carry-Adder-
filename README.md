...
The Project involves creating the 32bit RCA and implement it on the RTL to GDS flow.The steps include RTL coding, functional verification, synthesis, timing and power analysis, and physical design (including floorplanning, placement, clock tree synthesis, routing). 
...
1. Write the RTL code in Verilog for the 32 bit RCA.
...
<img width="850" height="886" alt="RCA32bit" src="https://github.com/user-attachments/assets/cb66ff16-2ab3-4809-adcc-2f6acd3fa317" />
